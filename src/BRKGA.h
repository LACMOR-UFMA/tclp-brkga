...
//Artigo referência: A C++ application programming interface for biased random-key genetic algorithms
...
#pragma omp parallel for if (MAX_THREADS > 1) num_threads(MAX_THREADS)
